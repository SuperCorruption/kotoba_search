...
class Article(models.Model):
    ...
    work_title = models.CharField(max_length=255, choices=[
        ...
        ("虹龍洞", "虹龍洞"), ("バレットフィリア達の闇市場", "バレットフィリア達の闇市場"), ("獣王園", "獣王園"), ("錦上京", "錦上京"),
        ...
        ("文果真報", "文果真報"), ("グリモワールオブウサミ", "グリモワールオブウサミ"), ("東方幻存神籤", "東方幻存神籤"), ("紫香花", "紫香花"),
        ...
        ("旧約酒場", "旧約酒場"), ("虹色のセプテントリオン", "虹色のセプテントリオン"), ("幺樂団の歴史", "幺樂団の歴史"),
        ("その他", "その他"), ("特になし", "特になし"),
        ]
    )
